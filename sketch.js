...
function setup() {
	...
	roof = new Roof (425,300,250,15);
	bobObject1 = new Bob (340,470,15)
	bobObject2 = new Bob (380,470,15)
	bobObject3 = new Bob (420,470,15)
	bobObject4 = new Bob (460,470,15)
	bobObject5 = new Bob (500,470,15);
